...
export const metadata: Metadata = {
  title: "Gerador de QR Code Grátis | EncurtaBR",
  description: "Crie e baixe QR Codes personalizados em alta resolução para links, WhatsApp, redes sociais e produtos. Rápido, grátis e sem cadastro.",
  alternates: {
    canonical: "/qr-code",
  },
};
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      <div className="text-center max-w-2xl mx-auto mb-10">
        ...
        <p className="mt-3 text-slate-500 text-base">
          Gere códigos QR para qualquer URL, texto ou rede social e faça download em formato PNG de alta qualidade.
        </p>
      </div>
      ...
      <div className="mt-12 bg-white border border-line rounded-2xl p-8 sm:p-10 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-600">
              Escolha a cor que combina com sua marca e selecione o tamanho desejado para impressão.
            </p>
          </div>
          <div className="space-y-2">
            <span className="text-brand-600 font-extrabold text-lg">3. Baixe e use</span>
            <p className="text-sm text-slate-600">
              Clique em baixar imagem PNG e adicione em embalagens, panfletos, cartões de visita ou sites.
            </p>
          </div>
        </div>

        <div className="pt-6 border-t border-line flex flex-wrap gap-6 text-xs font-semibold text-slate-500">
          <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-emerald-500" /> Sem expiração</span>
          <span className="flex items-center gap-1.5"><Zap className="w-4 h-4 text-amber-500" /> Leitura instantânea</span>
